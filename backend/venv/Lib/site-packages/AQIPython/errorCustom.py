...
class OutOfRangeError(Exception):
    ...
    def __init__(self,standard, concentration, pollutant ):
        self.standard = standard
        self.concentration = concentration
        self.pollutant = pollutant
        self.message = f"The entered pollutant \"{self.pollutant}\" of concentration \"{self.concentration} ug per m3\"  or the index of {self.standard} "
        super().__init__(self.message)